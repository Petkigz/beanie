...
| 38–41 | 1 | Failure taxonomy tags, consistency + contradiction counters in trace; the longitudinal suite now carries 21 multi-turn tasks (§8 target 20–30) with real action turns (observe/tick/demo/perform/body/query), environment staging, and honesty assertions (`expect_absent`, `expect_same_as`) |
