...
| [FIRST_SESSION.md](./FIRST_SESSION.md) | The 30-minute golden path on a real machine + Appendix A+ (bigger-brain seating in 3 env vars; both trades stated) — each step doubles as the level-2 evidence checklist |
...
tests/            277 tests incl. the conformance drift guard + T-test battery
